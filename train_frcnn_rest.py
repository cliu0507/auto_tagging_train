...
python train_frcnn_chang.py  --path "./data" 
...
parser.add_option("--output_weight_path", dest="output_weight_path", help="Output path for weights.", default='./model_frcnn_new.hdf5')
